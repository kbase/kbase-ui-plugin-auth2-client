define([
                        ...
                        div(
                            ...
                            [
                                ...
                                div({
                                    ...
                                    dataBind: {
                                        component: {
                                            name: UserProfileComponent.quotedName(),
                                            params: {
                                                runtime: 'runtime',
    ...
    class ViewModel {
        constructor({ runtime, profile }) {
            ...
            this.realname = {
                ready: true,
                field: ko.observable(profile.user.realname).extend({
                    constraint: {
                        required: true,
                        validate: (value) => {
                            if (value.length < 2) {
            ...
            this.jobTitleOther = {
                ...
                field: ko.observable(profile.profile.userdata.jobTitleOther).extend({
                    constraint: {
            ...
            this.researchInterestsOther = {
                ...
                field: ko.observable(profile.profile.userdata.researchInterestsOther).extend({
                    constraint: {
                        required: ko.pureComputed(() => {
            ...
            this.affiliations = {
                ...
                doc: {
                    ...
                    more: div([
                        p(['Maintaining your history of orgzniational affiliations can help other users identify you.'])
                    ])
                }
            };
            ...
            const vmFields = [
                ...
                this.avatarOption.field,
                this.gravatarDefault.field,
                this.affiliations.field,
                this.researchStatement.field,
                this.researchInterests.field,
                this.researchInterestsOther.field,
                this.fundingSource.field,
                this.jobTitle.field,
                this.jobTitleOther.field
            ];
