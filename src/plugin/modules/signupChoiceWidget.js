                    ...
                    body: div({
                                        ...
                                        div({
                                            ...
                                            div({
                                                ...
                                                table({
                                                    ...
                                                    tr([
                                                        th('Name on account'),
                                                        td(create.provfullname)
                                                    ]),
                                                    tr([
                                                        th('Username'),
                                                        td(create.provusername)
                                                    ]),
                                                    tr([
                                                        th('E-Mail Address'),
                                                        td(create.provemail)
                        ...
                        (function () {
                            var additionalCreates = choiceResponse.create.filter(function (create2) {
                                return (create2.provusername !== create.provusername);
                            });
                    ...
                    .then(function (choice) {
                        ...
                        if (choice.login) {
                            fixing = fixing.concat(choice.login.map(function (login) {
                                return evaluatePolicies(login.policyids)
